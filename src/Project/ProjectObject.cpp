...
namespace stimmt {
    ProjectObject::ProjectObject(QWidget * window)
        : QObject(window), m_win(window), m_thisObject(JS_QOBJ(this)), m_window(new ProjectWindowObject(this)),
          m_windowObject(JS_QOBJ(m_window)), m_scopedStorage(new ProjectScopedStorageObject(this)),
