...
namespace stimmt {
    ...
    ProjectWindowObject::ProjectWindowObject(ProjectObject * project) : QObject(project), m_project(project) {
        ...
        jsGlobal->defineEnum("CheckState", {{"Unchecked"}, {"PartiallyChecked"}, {"Checked"}});
        jsGlobal->defineEnum("Corner",
                             {{"TopLeftCorner"}, {"TopRightCorner"}, {"BottomLeftCorner"}, {"BottomRightCorner"}});
        jsGlobal->defineEnum("Direction", {{"LeftToRight"}, {"RightToLeft"}, {"TopToBottom"}, {"BottomToTop"}});
    ...
    QJSValue ProjectWindowObject::createButtonGroup() {
        ...
        auto obj =
            ObjectWrapper::wrap(btnGrp, jsGlobal->engine(), {"addButton", "checkedId", "id", "removeButton", "setId"});
    ...
    QJSValue ProjectWindowObject::renderElement(const QJSValue &description) {
        ...
        auto elm = m_elementDescriptiveDict.value(tag)(targetDescription.property("attributes"),
                                                       targetDescription.property("children"));
        return elm;
    }
    ...
    void ProjectWindowObject::bindIdAccessorToElement(QJSValue element) {
        ObjectWrapper::addAccessorProperty(
            element, jsGlobal->engine(), "id", [=]() { return element.property("_elmId"); },
            [=](const QJSValue &id) {
