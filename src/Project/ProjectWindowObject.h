#ifndef STIMMT_PROJECTWINDOWOBJECT_H
#define STIMMT_PROJECTWINDOWOBJECT_H
...
namespace stimmt {
    ...
    class STIMMT_EXPORT ProjectWindowObject : public QObject {
        Q_OBJECT
    ...
    private:
        ...
        void addElementClass(const QString &tagName) {
            ...
            m_elementDescriptiveDict.insert(tagName, [this](const QJSValue &attributes, const QJSValue &children) {
                ...
                auto obj = t->createScriptObject();
                bindIdAccessorToElement(obj);
                t->configureThisScriptObjectByDescription(obj, attributes, children,
                                                          [this](const QJSValue &arg) { return renderElement(arg); });
                return obj;
            });
        }
...
#endif // STIMMT_PROJECTWINDOWOBJECT_H
