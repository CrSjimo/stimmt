...
namespace stimmt {
    ...
    using extension::Console;

    JavaScriptOutputWidget::JavaScriptOutputWidget(Console *console, QWidget *parent) : QWidget(parent), m_textEdit(new QTextBrowser) {
        ...
        connect(console, &Console::messagePrinted, this, &JavaScriptOutputWidget::receiveMessage);
        connect(console, &Console::clearRequested, this, &JavaScriptOutputWidget::clear);
    }
    ...
    void JavaScriptOutputWidget::receiveMessage(int level, const QString &message, const QString &fileTrace) {
        ...
        if (!levelImage.isEmpty()) {
            ...
            int imgSize = QFontInfo(m_textEdit->font()).pixelSize();
