#ifndef STIMMT_CONSOLE_H
#define STIMMT_CONSOLE_H
...
namespace stimmt::extension {
    ...
    class STIMMT_EXPORT Console : public QObject {
        Q_OBJECT
        Q_DECLARE_PRIVATE(Console)
    public:
        explicit Console(QJSEngine *engine, QObject *parent = nullptr);
        ~Console() override;
        enum Level {
            Debug,
            Info,
    ...
    protected:
        Console(QObject *parent, ConsolePrivate &d);

    private:
        QScopedPointer<ConsolePrivate> d_ptr;
    };

} // extension

#endif //STIMMT_CONSOLE_H
